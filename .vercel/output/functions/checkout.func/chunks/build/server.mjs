import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, resolveComponent, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { C as klona, D as parseURL, E as encodePath, F as decodePath, G as defuFn, c as createError$1, H as hasProtocol, I as isScriptProtocol, B as joinURL, w as withQuery, J as sanitizeStatusCode, K as getContext, $ as $fetch$1, L as baseURL, M as defu, N as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DXiq5bIw.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-C8eYpWIr.mjs'),
  auth: () => import('./auth-BtRmxfys.mjs'),
  guest: () => import('./guest-CsMtvuXI.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BRIQUDJU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-oSjUPpWJ.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useState as b, useRoute as c, defineNuxtRouteMiddleware as d, entry_default as default, useRouter as e, fetchDefaults as f, encodeRoutePath as g, useNuxtApp as h, useRuntimeConfig as i, nuxtLinkDefaults as j, appConfig as k, asyncDataDefaults as l, createError as m, navigateTo as n, resolveRouteObject as r, useHead as u };
